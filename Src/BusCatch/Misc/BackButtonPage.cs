...
namespace BusCatch.Misc
{
  public class BackButtonPage : Page
  {
    protected override void OnNavigatedTo(NavigationEventArgs e)
    {
      BackButtonVis = base.Frame.CanGoBack ? AppViewBackButtonVisibility.Visible : AppViewBackButtonVisibility.Collapsed;
    ...
    public AppViewBackButtonVisibility BackButtonVis
    {
