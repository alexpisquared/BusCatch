...
{
  public sealed partial class StopLocatorUsrCtrl : UserControl
  {
    public StopLocatorUsrCtrl()
    {
    ...
    void tbS_GotFocus(object sender, RoutedEventArgs e) { ((TextBox)sender).SelectionStart = ((TextBox)sender).Text.Length; }
  }
}
